...
- Set up a professional development environment from scratch.
...
- Follow lectures and document exercises to a learning diary.

### Path 2: Independent Track
- Build an app from your own idea that matches course requirements.
- Use cross-platform technology of your choosing that satisfies criteria.
